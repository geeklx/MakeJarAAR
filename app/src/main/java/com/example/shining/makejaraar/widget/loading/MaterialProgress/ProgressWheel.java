...
public class ProgressWheel extends View {
    ...
    private double barSpinCycleTime = 600;
    ...
    /**
     * @return the base spinning speed, in video_full circle turns per second
     * (1.0 equals on video_full turn in one second), this value also is applied for
    ...
    /**
     * Sets the base spinning speed, in video_full circle turns per second
     * (1.0 equals on video_full turn in one second), this value also is applied for
     * the smoothness when setting a progress
     *
     * @param spinSpeed the desired base speed in video_full turns per second
     */
